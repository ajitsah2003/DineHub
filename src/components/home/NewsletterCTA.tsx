    ...
    return (
        <section className="bg-primary-container text-on-primary py-20 xl:py-32 text-center">
            <div className="max-w-2xl mx-auto px-6">
                <h2 className="font-display text-2xl md:text-3xl text-white mb-4">    Join Our Premium Club ⭐</h2>
                <p className="text-sm text-on-primary-container mb-8 leading-relaxed">
                   1. Subscribe to get early access to new restaurants and exclusive offers. 
                </p>
